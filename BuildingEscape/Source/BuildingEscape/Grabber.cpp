...
void UGrabber::Grab() {
	...
	AActor* Actor = GetFirstPhysicsBodyInReach();
	if (Actor)
...
AActor* UGrabber::GetFirstPhysicsBodyInReach() {
	...
	FHitResult Hit = GetLineTraceHitResult(PlayerViewPointLocation, LineTraceEnd);
